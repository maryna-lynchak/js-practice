const { getPostById, createPost } = require("../controllers/postsController");
...
test("Test GET posts 3", async () => {
  const response = await getPostById(7);
...
test("Test GET posts 4", async () => {
  const response = await getPostById(3);
...
test("Test GET posts 5", async () => {
  const response = await getPostById(10);
